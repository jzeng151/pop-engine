...
- Every negative-answer boundary retains its substantive result and also emits the applicable nyc.v2.9 confirmation; the acceptance suite compares substantive rule IDs separately from confirmation IDs so neither can hide a regression in the other.
