...
| INFEASIBLE       | a finding at or above `required` in the disposition strength order, asserted off a trigger that resolved, is PUBLISHED_DEADLINE_MISSED (amended 2026-08-08; see below) | "Published deadline missed as scoped" — a missed filing window, **not** a claim of legal impossibility |
