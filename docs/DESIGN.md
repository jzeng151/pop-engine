...
- The ruleset's SOURCE_CONFIRMED facts are checked against their primary sources in a browser and promoted per fact to VERIFIED by the product owner before the demo, with the second signatory `DOCUMENTATION-GOVERNANCE.md` §6's closing paragraph requires whenever the product owner authored the promotion.
