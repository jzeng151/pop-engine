...
**Status:** HISTORICAL PROPOSAL. The product owner approved a later disposition on 2026-08-19,
recorded in `docs/BASELINE.md` and `specs/F-201-permit-plan-generator.md`. This brief is not an
APPROVED baseline artifact. Its present-tense recommendations and open questions below record the
state before that approval and are not current instructions.
