...
The second-signatory element of all this was **retired by the product owner on 2026-08-05**, recorded
in `docs/BASELINE.md` and landed by PR #248, which removes §6's closing paragraph. None is required
for AD-18 and none is claimed. This record therefore argues no second-signatory question of its own:
the paragraphs above reasoned that §6's closing paragraph's first sentence was not reached, which was
the live question when they were written, and the retirement removes the sentence they reasoned
about. AD-18 is signed by the product owner, which is the whole requirement. Because PR #248 carries
that retirement, **this change must not merge before it**.
