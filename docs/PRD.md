...
**Issue #181 amendment (2026-07-29):** retargeted to nyc.v2.10, which corrects SAPO-BLOCK-PARTY-ELIG-001's source attribution from the CECM FAQ to the cited CECM block-parties page. No source URL, rule behavior, verification status, fixture output, or verdict changes.
