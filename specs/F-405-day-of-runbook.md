...
- F-202 checklist, F-208/F-209 records where present, F-405's runbook-only staff assignments, and the F-701/F-702/F-703 gate.
- [SPEC-CONFLICT #207](https://github.com/jzeng151/pop-engine/issues/207) is resolved for this proposal: F-405 owns the minimal Phase 2 runbook-assignment source required by the PRD/Roadmap, while F-213 remains the Phase 3 general team-task feature and is not an F-405 dependency. This resolution does not approve either spec.
