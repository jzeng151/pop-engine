...
- Create commits but its response is lost: Save again replays the original key and body, recovers the same event ID, and generates that event's first plan instead of inserting a duplicate.
