...
- Approve separation-of-duties matrix, including the approval-record version and supersession rule AC-04 compares, artifact/pointer transaction, cache/recovery runbook, reauthentication, and git cutover.
