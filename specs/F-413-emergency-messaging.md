...
9. **F413-AC-09:** Draft creation and final confirmation each carry their own stable client-supplied request identity, supplied before the record each one creates exists.
