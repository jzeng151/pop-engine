...
- Join/leave waitlist, preserve order, atomically promote the next eligible entry, and deliver a transactional promotion notice.
...
2. **F306-AC-02:** When exactly one place frees, one transaction promotes the earliest eligible entry and cannot overbook under concurrent workers/requests.
