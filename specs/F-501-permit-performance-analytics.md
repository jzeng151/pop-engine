...
- F501-AC-08 includes a cross-workspace source fixture in which a metric, filter, or drill-down would read an F-208 record outside the admitted workspace: the record enters neither numerator, denominator, nor coverage count, its exclusion is reported as coverage rather than a silently narrowed figure, and no export or download carries it.
